...
export async function getSlideInfo(slideID) {
  const slideInfoPayload = await fetchGraphQL(`query{
    ...
    return {
      slideInfo: extractSlideInfo(slideInfoPayload)
    }
}
...
export async function getAllServiceCategories() {
  ...
  return {
    serviceCategories: extractCategories(categories)
  }
}
...
export async function getAllServices() {
  ...
  return {
    serviceList: extractAndSortServiceList(services, categories)
  }
}
...
export async function getAllProjects() {
  ...
  return {
    highlightedProjects: extractProjectEntries(entries)
  }
}
...
export async function getHighlightedProjects() {
  ...
  return {
    highlightedProjects: extractProjectEntries(highlightedProjects)
  }
}